...
#define	 immagine_in_scrittura_ppm	"../image/img2.ppm"       /* immagine in scrittura  in forma pgm */
#define  immagine_in_scrittura          "../image/img2.txt"           /* immagine in scrittura in forma matriciale */
