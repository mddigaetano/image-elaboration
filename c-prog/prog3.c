...
#define	 immagine_in_scrittura_ppm	"../image/img3.ppm"       /* immagine in scrittura  in forma pgm */
#define  immagine_in_scrittura          "../image/img3.txt"           /* immagine in scrittura in forma matriciale */
...
main()
{
  ...
  leggi();                  // lettura dai dati dal file
    ...
    i = M/2;
    for(j = 0; j < N; j++){
      immagine_degradata_rossa[i][j] = 0;
      immagine_degradata_verde[i][j] = 0;
      immagine_degradata_blu[i][j] = 0;
    }
